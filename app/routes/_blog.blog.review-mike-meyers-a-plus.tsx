  ...
  return (
    <>
      ...
      <Paragraph>
        ...
        saying that should change. IT support and development are two very
        different specializations. But I do think developers should be familiar
        with the hardware they&apos;re working on and have the basic knowledge
