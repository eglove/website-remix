    ...
    <>
      ...
      <Paragraph>
        ...
        <div className="grid gap-2">
          ...
          <p className="grid grid-cols-auto-1fr items-center gap-2">
            <NoSymbolIcon color="red" height={16} width={16} />
            Needs framework for work with edge such as creating Buffer&apos;s
            for PassKey Auth.
          </p>
          <p className="grid grid-cols-auto-1fr items-center gap-2">
            <NoSymbolIcon color="red" height={16} width={16} />
      ...
      <Paragraph>
        ...
        <div className="grid gap-2">
          ...
          <p className="grid grid-cols-auto-1fr items-center gap-2">
            ...
            Developers have lost access to simple things like headers and
            cookies which makes it difficult to work with Browser APIs.
          </p>
          <p className="grid grid-cols-auto-1fr items-center gap-2">
            <ExclamationCircleIcon color="orange" height={16} width={16} />
            NextJS was built with edge runtime in mind. However basic things
            like the Image component do not work outside of Vercel. Every
            provider has to go through great pains to support NextJS without
            guidance on how do so. To get images to display with CloudFlare,
            they have a guide on creating a custom loader for images on
            CloudFlare CDN. But that is not a complete solution.
          </p>
          <p className="grid grid-cols-auto-1fr items-center gap-2">
            <NoSymbolIcon color="red" height={16} width={16} />
            Same as the second point, in terms of intercepting HTML form
            actions, these features are experimental.
          </p>
        </div>
      </Paragraph>
      <Paragraph>
        ...
        <div className="grid gap-2">
          ...
          <p className="grid grid-cols-auto-1fr items-center gap-2">
            <CheckCircleIcon color="green" height={16} width={16} />
            Does a great job of exposing Browser APIs where they&apos;re used
            and encouraging their use as much as possible.
          </p>
          <p className="grid grid-cols-auto-1fr items-center gap-2">
            <NoSymbolIcon color="red" height={16} width={16} />
            The CloudFlare adapter is a bit rough. You have to get environment
            variables off of context in loaders/actions, which isn&apos;t the
            end of the world, but can be annoying. And NodeJS compatibility is
            not available.
          </p>
          <p className="grid grid-cols-auto-1fr items-center gap-2">
            <CheckCircleIcon color="green" height={16} width={16} />
            ...
            &lsquo;useSubmit&rsquo; hook that can be good for running client
            side logic before posting a form while still keeping the
      ...
      <Paragraph>
        ...
        <div className="grid gap-2">
          ...
          <p className="grid grid-cols-auto-1fr items-center gap-2">
            ...
            synchronize state which causes the server to often be one step
            behind the client. And form values are not pulled from input values.
            Put these together and forms are unreliable.
          </p>
          <p className="grid grid-cols-auto-1fr items-center gap-2">
            <NoSymbolIcon color="red" height={16} width={16} />
          ...
          <p className="grid grid-cols-auto-1fr items-center gap-2">
            <ExclamationCircleIcon color="orange" height={16} width={16} />
            The CloudFlare adapter for QwikCity works great as long as you use
            the CloudFlare template. However, the issue I have here is Qwik
            serialization. If you care about NodeJS compatibility, you&apos;re
            thinking about things like Buffer and Crypto. Because these
            can&apos;t be serialized, it&apos;s often difficult to figure out
            how to get them through Qwik&apos;s numerous &ldquo;serialization
            boundaries&rdquo;.
          </p>
          <p className="grid grid-cols-auto-1fr items-center gap-2">
            <NoSymbolIcon color="red" height={16} width={16} />
            Again the issue here is synchronization. You can not reliably
            predict what a server will return, and when a UI will update. The
            API&apos;s here are not clear and have many inconsistent behaviors
            due to bad state management and the framework apparently being built
            primarily for having JavaScript disabled.
          </p>
        </div>
      </Paragraph>
    </>
