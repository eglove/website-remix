  ...
  return (
    <>
      ...
      <Paragraph>
        ...
        everyone does this. Car models do this. I can&apos;t dock it too much.
        But the course is still using Bootstrap. Bootstrap is still a valid
        tool, even if it isn&apos;t as popular as it used to be. Andrei moves
        into CSS grid and flex later which are the more relevant skills today.
        Getting into those right away may be overwhelming for a new developer.
      ...
      <Paragraph>
        ...
        And often those videos are patches that say “in the next video, do this
