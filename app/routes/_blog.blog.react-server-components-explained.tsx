  ...
  return (
    <>
      ...
      <Paragraph>
        ...
        components. They run on <span className="font-bold">both</span> the
        client and server. But they can not use server-only features. They have
        to be able to run on re-renders. To put it another way{' '}
